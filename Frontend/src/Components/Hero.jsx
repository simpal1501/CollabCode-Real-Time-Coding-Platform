            ...
            <div className="w-full px-4">
              ...
              >
                <div className="mb-5 text-3xl font-bold leading-tight  sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight flex  justify-center items-center gap-4">
                  <span className='text-4xl md:text-6xl tracking-tight font-bold text-transparent bg-clip-text bg-gradient-to-bl from-zinc-800 via-slate-200 to-zinc-900 h-20 md:mt-6 mt-10 font-heading'>CollabCode</span>
                </div>
